...
class Admin_model extends CI_Model {
    ...
    function insert_user($postData){
        ...
        if($validate){
            ...
            $module = "Gestion d'utilisateur";
            $activity = "ajouter le nouvel utilisateur ".$postData['email'];
    ...
    function update_user_details($postData){
        ...
        if($validate){
            ...
            $record = "(".$oldData[0]['email']." à ".$postData['email'].", ".$oldData[0]['name']." à ".$postData['name'].",".$oldData[0]['role']." à ".$postData['role'].")";

            $module = "Gestion d'utilisateur";
            $activity = "mise à jour des infos de l'utilisateur ".$oldData[0]['email'].$record;
            $this->insert_log($activity, $module);
    ...
    function deactivate_user($email,$id){
        ...
        $module = "Gestion d'utilisateur";
        $activity = "supprimer l'utilisateur ".$email;
        $this->insert_log($activity, $module);
        return array('status' => 'success', 'message' => '');
    ...
    function reset_user_password($email,$id){
        ...
        $module = "Gestion d'utilisateur";
        $activity = "réinitialiser le mot de passe de l'utilisateur ".$email;
        $this->insert_log($activity, $module);
        return array('status' => 'success', 'message' => '');
