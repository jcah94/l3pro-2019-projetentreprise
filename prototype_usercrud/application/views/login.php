	        ...
	        <div class="col-md-4 col-md-offset-4">
	            <div class="login-panel panel panel-default">
	                <div class="panel-heading">
	                    <h3 class="panel-title">Prototype - Connexion</h3>
	                </div>
	                <div class="panel-body">
	                	<small id="login-empty-input" class="error">email ou mot de passe ne peut pas être vide <br>&nbsp;</small>
	                	<?php if($alert): ?>
	                		<small id="login-invalid-input" class="error">email ou mot de passe invalide<br>&nbsp;</small>
	                	<?php endif; ?>
	                    ...
	                    <form role="form" method="post" onsubmit="return checkEmptyInput();" action="<?=base_url()?>authentication/login/">
	                        <fieldset>
	                            ...
	                            <div class="form-group">
	                                <small><a href="#" onclick="alert('Contactez l'administrateur pour réinitialiser votre mot de passe')">Mot de passe oublié</a></small>
	                            </div>
